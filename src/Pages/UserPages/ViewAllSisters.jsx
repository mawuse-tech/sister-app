...
const ViewAllSisters = () => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:gap-28 gap-5 px-4 w-full  absolute top-10 lg:top-12 z-10">
          ...
          <div className="flex justify-between gap-4 w-full lg:w-auto">
            ...
            <div className="dropdown dropdown-bottom">
              <div tabIndex={0} role="button" className="btn m-1 w-full lg:w-40 bg-white border-none text-[#5651AB] flex justify-between">
                Field <FiChevronDown />
              </div>
              <ul
                tabIndex={0}
      ...
      {/* Body Section */}
      <div className="bg-[#DFEBFB]  h-full pt-6 px-4 ">
